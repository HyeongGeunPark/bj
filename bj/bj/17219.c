...
#define bmap_init_dynamic(name, bit) long *name = calloc(bit_to_long(bit),
sizeof(long)) #define bmap_free_dynamic(name) free(name) #define bmap_set(name,
bit) name[bit_to_index(bit)] |= (((long)1)<<(bit_to_offset(bit))) #define
bmap_reset(name, bit) name[bit_to_index(bit)] &=
~(((long)1)<<(bit_to_offset(bit))) #define bmap_toggle(name, bit)
name[bit_to_index(bit)] ^= (((long)1)<<(bit_to_offset(bit))) #define
bmap_get(name, bit) ((name[bit_to_index(bit)]>>(bit_to_offset(bit))) &
((long)1)) #define bmap_set_all_long(name, bit) name[bit_to_index(bit)] |=
0xffffffff #define bmap_reset_all_long(name, bit) name[bit_to_index(bit)] &= 0
