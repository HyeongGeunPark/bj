...
public:
	...
	SkipList(int maxlevel = 32, double p = 0.5)
		:maxlevel{ maxlevel }, p{ p }, head{ keytype{}, datatype{}, 0 },
		rd{}, gen{ rd() }, dis(1, p),
		sz{ 0 }
	{ }
	 ...
	 * @return true on success, false on failure(e.g. there is no Node with given key)
	 */
	bool erase(int key) {
		Node* current = &head;
